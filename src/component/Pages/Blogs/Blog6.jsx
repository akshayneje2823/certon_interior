          ...
          <div className="single-content-wrap">
            <div className="w-layout-grid blog-single-grid">
              <div className="blog-single-content-wrap">
                ...
                <img
                  src="../../uploads-ssl.webflow.com/619cc60416b9688293f54eda/61a1be15c0eccd1e8f164de5_blog-image-large-6.jpg"
                  loading="lazy"
                ...
                <div className="blog-meta-details">
                  ...
                  <div className="blog-meta-category">Minimalist Interior</div>
                </div>
